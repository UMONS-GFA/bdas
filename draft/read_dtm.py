...
#def dripcounter(datein,dateout,freq = 'minutes',path='C:\Users\Arno\Documents\Pluvio\\'):


if __name__ == '__main__':
    directory = 'C:/Users\Arno\Documents\Compteur de gouttes\\'
    files = glob.glob(directory+'test.dtm')
    files = glob.glob(directory+'R013Full_20150528_0600.dtm')
    for file in files:
    ...
    # print(data)
    df = data[[data.columns[1],data.columns[4]]]
